...
sam = xr.open_dataset("/Users/xiao169/work/clubb/les_output/lba/lba_r1_z.nc")
...
# f = FortranFile("/Users/xiao169/work/clubb/pdf_closure/data/input_lba_r1_skx.bin", "w")
f = FortranFile("/Users/xiao169/work/clubb/pdf_closure/data/input_lba_r1.bin", "w")
for var in [
    rtm,
    thlm,
    wp2,
