...
sam = xr.open_dataset("/Users/xiao169/work/clubb/les_output/bomex/BOMEX_r1_z.nc")
...
f = FortranFile(
    # "/Users/xiao169/work/clubb/pdf_closure/data/input_bomex_r1_skx.bin",
    "/Users/xiao169/work/clubb/pdf_closure/data/input_bomex_r1.bin",
    "w",
)
for var in [
    rtm,
