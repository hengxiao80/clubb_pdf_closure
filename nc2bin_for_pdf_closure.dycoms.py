...
# wrfstat = xr.open_dataset("/global/homes/x/xiao169/tracking/dycoms/old_dycomsrf01/slw_wf_100/stat/wrf.nc")
wrfstat = xr.open_dataset("/global/homes/x/xiao169/tracking/dycoms/old_dycomsrf02/dycoms_slw_wf_250/stat/wrf.nc")
...
f = FortranFile(
    # "input_dycomsrf01.bin",
    # "input_dycomsrf02.bin",
    # "input_dycomsrf01_skx.bin",
    "input_dycomsrf02_skx.bin",
    "w",
)
for var in [
    rtm,
